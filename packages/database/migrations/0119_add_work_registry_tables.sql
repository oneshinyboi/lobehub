...
CREATE INDEX IF NOT EXISTS "works_root_operation_updated_at_id_idx" ON "works" USING btree ("root_operation_id","updated_at","id") WHERE "works"."root_operation_id" is not null;
