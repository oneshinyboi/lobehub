...
ALTER TABLE "works" DROP CONSTRAINT IF EXISTS "works_source_topic_id_topics_id_fk";--> statement-breakpoint
ALTER TABLE "works" ADD CONSTRAINT "works_source_topic_id_topics_id_fk" FOREIGN KEY ("source_topic_id") REFERENCES "public"."topics"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "works" DROP CONSTRAINT IF EXISTS "works_source_thread_id_threads_id_fk";--> statement-breakpoint
ALTER TABLE "works" ADD CONSTRAINT "works_source_thread_id_threads_id_fk" FOREIGN KEY ("source_thread_id") REFERENCES "public"."threads"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "works_source_topic_id_idx" ON "works" USING btree ("source_topic_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "works_source_thread_id_idx" ON "works" USING btree ("source_thread_id");
