export default {
  ...
  'oauthApp.detail.save': 'Save',
  'oauthApp.detail.saveSuccess': 'Saved',
  ...
  'oauthApp.list.actions.view': 'View',
  'oauthApp.list.columns.actions': 'Actions',
  'oauthApp.list.columns.clientId': 'Client ID',
  'oauthApp.list.columns.createdAt': 'Created',
  'oauthApp.list.columns.lastUsedAt': 'Last Used',
  'oauthApp.list.columns.name': 'Name',
  'oauthApp.list.columns.status': 'Enabled',
  'oauthApp.list.columns.type': 'Type',
  'oauthApp.list.neverUsed': 'Never used',
  'oauthApp.list.title': 'OAuth Apps',
